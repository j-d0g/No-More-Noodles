...
<body id="body">
	...
	<div class="sidepanel-bg">
		...
		<p id="intro-text" class="sidepanel">
			<p class="sidepanel-bg123">
			Explore Easy and fast cooking recipes that are delicate and exquisite. Search recipes, ingredients, and cuisines below:
		  </p>
		<!-- <div class="searchbar"> -->
